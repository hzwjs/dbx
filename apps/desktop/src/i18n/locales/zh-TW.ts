...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "複製選區為 INSERT",
    copySelectionInsertMerged: "複製選區為 INSERT（合併）",
    copySelectionInsertRowByRow: "複製選區為 INSERT（逐筆）",
    clearSelection: "清除選區",
    export: "匯出",
    exportCsv: "匯出 CSV",
    exportXlsx: "匯出 XLSX",
  ...
  configExport: {
    ...
    exportEncrypted: "匯出",
    modeTitle: "匯出連線設定",
    modeHint: "請選擇連線設定的保護方式。",
    exportPlain: "一般匯出",
    plainExportWarning: "一般匯出檔案包含連線密碼及其他憑證，請妥善保存，切勿隨意分享。",
    exportPlainSuccess: "連線設定已一般匯出",
    decryptImport: "解密並匯入",
