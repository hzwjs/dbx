...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "選択範囲をINSERTとしてコピー",
    copySelectionInsertMerged: "選択範囲をINSERTとしてコピー（まとめて）",
    copySelectionInsertRowByRow: "選択範囲をINSERTとしてコピー（行ごと）",
    ...
    copySelectedRowsTsv: "{count}行をコピー (TSV)",
    copySelectedRowsTsvWithHeaders: "{count}行をヘッダー付きでコピー (TSV)",
    copySelectedRowTsv: "1行をコピー (TSV)",
    copySelectedRowTsvWithHeaders: "1行をヘッダー付きでコピー (TSV)",
    copyColumnsJson: "{count}列をコピー (JSON)",
    copyRowsInsert: "{count}行をINSERTとしてコピー",
    copyRowsInsertMerged: "{count}行をINSERTとしてコピー（まとめて）",
    copyRowsInsertRowByRow: "{count}行をINSERTとしてコピー（行ごと）",
    copyRowsInsertWithoutPrimaryKeys: "{count}行を主キーなしでINSERTとしてコピー",
    copyRowsInsertWithoutPrimaryKeysMerged: "{count}行を主キーなしでINSERTとしてコピー（まとめて）",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "{count}行を主キーなしでINSERTとしてコピー（行ごと）",
  ...
  configExport: {
    ...
    modeTitle: "接続設定をエクスポート",
    modeHint: "エクスポートする接続設定の保護方法を選択してください。",
    exportPlain: "通常エクスポート",
    plainExportWarning: "通常ファイルには接続パスワードなどの認証情報が含まれます。安全に保存し、共有しないでください。",
    exportPlainSuccess: "接続設定を暗号化せずにエクスポートしました",
