...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "复制选区为 INSERT",
    copySelectionInsertMerged: "复制选区为 INSERT（合并）",
    copySelectionInsertRowByRow: "复制选区为 INSERT（逐行）",
    clearSelection: "清除选区",
    export: "导出",
    exportCsv: "导出 CSV",
    exportXlsx: "导出 XLSX",
  ...
  configExport: {
    ...
    exportEncrypted: "导出",
    modeTitle: "导出连接配置",
    modeHint: "请选择连接配置的保护方式。",
    exportPlain: "普通导出",
    plainExportWarning: "普通导出文件包含连接密码及其他凭据，请妥善保存，切勿随意分享。",
    exportPlainSuccess: "连接配置已普通导出",
    decryptImport: "解密并导入",
  ...
  sqlFile: {
    ...
    batchProgress: "已完成 {completed}/{total} 个目标",
    partialSuccess: "部分成功",
    pending: "等待执行",
    skipped: "已跳过",
    failureDetails: "语句失败详情",
    setupOrTerminalError: "准备或终止错误",
    failedStatement: "第 {index} 条语句失败",
    noDatabase: "未选择数据库",
    runInBackground: "后台运行",
    stopBatch: "停止批量执行",
    cancelling: "正在取消...",
