export default {
  ...
  grid: {
    ...
    copySelectionInsert: "Copy Selection as INSERT",
    copySelectionInsertMerged: "Copy Selection as INSERT (Merged)",
    copySelectionInsertRowByRow: "Copy Selection as INSERT (Row by Row)",
    clearSelection: "Clear Selection",
    export: "Export",
  ...
  configExport: {
    ...
    modeTitle: "Export connection configuration",
    modeHint: "Choose how to protect the exported connection configuration.",
    exportPlain: "Plain export",
    plainExportWarning: "The plain file contains connection passwords and other credentials. Store it securely and do not share it.",
    exportPlainSuccess: "Connections exported without encryption",
  ...
  sqlFile: {
    ...
    batchProgress: "{completed} of {total} targets complete",
    partialSuccess: "Partially succeeded",
    pending: "Pending",
    skipped: "Skipped",
    failureDetails: "Statement failures",
    setupOrTerminalError: "Setup or terminal error",
    failedStatement: "Statement {index} failed",
    noDatabase: "No database selected",
    runInBackground: "Run in Background",
