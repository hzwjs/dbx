...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "Copia Selezione come INSERT",
    copySelectionInsertMerged: "Copia Selezione come INSERT (unito)",
    copySelectionInsertRowByRow: "Copia Selezione come INSERT (riga per riga)",
    clearSelection: "Cancella Selezione",
    export: "Esporta",
    ...
    copySelectedRowsTsv: "Copia {count} Righe (TSV)",
    copySelectedRowsTsvWithHeaders: "Copia {count} Righe con Intestazioni (TSV)",
    copySelectedRowTsv: "Copia 1 Riga (TSV)",
    copySelectedRowTsvWithHeaders: "Copia 1 Riga con Intestazioni (TSV)",
    copyColumnsJson: "Copia {count} Colonne (JSON)",
    copyRowsInsert: "Copia {count} Righe come INSERT",
    copyRowsInsertMerged: "Copia {count} Righe come INSERT (unito)",
    copyRowsInsertRowByRow: "Copia {count} Righe come INSERT (riga per riga)",
    copyRowsInsertWithoutPrimaryKeys: "Copia {count} Righe come INSERT senza Chiavi Primarie",
    copyRowsInsertWithoutPrimaryKeysMerged: "Copia {count} Righe come INSERT senza Chiavi Primarie (unito)",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copia {count} Righe come INSERT senza Chiavi Primarie (riga per riga)",
  ...
  configExport: {
    ...
    modeTitle: "Esporta configurazione connessioni",
    modeHint: "Scegli come proteggere la configurazione esportata.",
    exportPlain: "Esportazione non cifrata",
    plainExportWarning: "Il file contiene password e altre credenziali. Conservalo in modo sicuro e non condividerlo.",
    exportPlainSuccess: "Configurazione esportata senza crittografia",
