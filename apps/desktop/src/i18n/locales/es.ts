...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "Copiar selección como INSERT",
    copySelectionInsertMerged: "Copiar selección como INSERT (combinado)",
    copySelectionInsertRowByRow: "Copiar selección como INSERT (fila por fila)",
    clearSelection: "Limpiar selección",
    export: "Exportar",
    ...
    copySelectedRowsTsv: "Copiar {count} filas (TSV)",
    copySelectedRowsTsvWithHeaders: "Copiar {count} filas con encabezados (TSV)",
    copySelectedRowTsv: "Copiar 1 fila (TSV)",
    copySelectedRowTsvWithHeaders: "Copiar 1 fila con encabezados (TSV)",
    copyColumnsJson: "Copiar {count} columnas (JSON)",
    copyRowsInsert: "Copiar {count} filas como INSERT",
    copyRowsInsertMerged: "Copiar {count} filas como INSERT (combinado)",
    copyRowsInsertRowByRow: "Copiar {count} filas como INSERT (fila por fila)",
    copyRowsInsertWithoutPrimaryKeys: "Copiar {count} filas como INSERT sin claves primarias",
    copyRowsInsertWithoutPrimaryKeysMerged: "Copiar {count} filas como INSERT sin claves primarias (combinado)",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copiar {count} filas como INSERT sin claves primarias (fila por fila)",
  ...
  configExport: {
    ...
    modeTitle: "Exportar configuración de conexiones",
    modeHint: "Elige cómo proteger la configuración exportada.",
    exportPlain: "Exportación sin cifrar",
    plainExportWarning: "El archivo contiene contraseñas y otras credenciales. Guárdalo de forma segura y no lo compartas.",
    exportPlainSuccess: "Configuración exportada sin cifrado",
