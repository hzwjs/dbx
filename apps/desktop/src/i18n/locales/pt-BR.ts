...
export default withEnglishFallback({
  ...
  grid: {
    ...
    copySelectionInsert: "Copiar Seleção como INSERT",
    copySelectionInsertMerged: "Copiar Seleção como INSERT (mesclado)",
    copySelectionInsertRowByRow: "Copiar Seleção como INSERT (linha por linha)",
    clearSelection: "Limpar Seleção",
    export: "Exportar",
    ...
    copySelectedRowsTsv: "Copiar {count} Linhas (TSV)",
    copySelectedRowsTsvWithHeaders: "Copiar {count} Linhas com Cabeçalhos (TSV)",
    copySelectedRowTsv: "Copiar 1 Linha (TSV)",
    copySelectedRowTsvWithHeaders: "Copiar 1 Linha com Cabeçalhos (TSV)",
    copyColumnsJson: "Copiar {count} Colunas (JSON)",
    copyRowsInsert: "Copiar {count} Linhas como INSERT",
    copyRowsInsertMerged: "Copiar {count} Linhas como INSERT (mesclado)",
    copyRowsInsertRowByRow: "Copiar {count} Linhas como INSERT (linha por linha)",
    copyRowsInsertWithoutPrimaryKeys: "Copiar {count} Linhas como INSERT sem Chaves Primárias",
    copyRowsInsertWithoutPrimaryKeysMerged: "Copiar {count} Linhas como INSERT sem Chaves Primárias (mesclado)",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copiar {count} Linhas como INSERT sem Chaves Primárias (linha por linha)",
  ...
  configExport: {
    ...
    modeTitle: "Exportar configuração de conexões",
    modeHint: "Escolha como proteger a configuração exportada.",
    exportPlain: "Exportação sem criptografia",
    plainExportWarning: "O arquivo contém senhas e outras credenciais. Armazene-o com segurança e não o compartilhe.",
    exportPlainSuccess: "Configuração exportada sem criptografia",
